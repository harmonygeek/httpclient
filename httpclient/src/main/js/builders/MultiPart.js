...
class MultiPart {
  ...
  createRequestBody() {
    if (this[_content])
    this[_content] = ArrayBuffer.bind([this[_content], new ArrayBuffer(MULTIPART_MARK + this[_boundary]
    + MULTIPART_MARK + LF)]);
  ...
  static get Builder() {
    class Builder {
      ...
      addPart(body) {
        ...
        var body1 = new ArrayBuffer(MULTIPART_MARK + this[_boundary] + LF + mimesStr + LF);
        var body2 = new ArrayBuffer(body.content);
        var body3 = new ArrayBuffer(LF);
        var buffResult = ArrayBuffer.bind([body1, body2, body3]);

        if (this[_content])
        this[_content] = ArrayBuffer.bind([this[_content], buffResult]);
        else
        this[_content] = buffResult;
